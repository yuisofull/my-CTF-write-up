def transform(num):
    ...
    number += 33
    number /= 6
    number -= org # always 13
    if number == 13: # always true
        ...
        number *= 5
        number += num2
        number -= 25  #(num1 * 2 +5)*5+num2-25=10*num1+num2 
        if int(number / 10) == num1 and number % 10 == num2: #always true
